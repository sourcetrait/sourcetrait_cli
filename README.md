...
*Command-line interface for SourceTrait projects*


Crates (In Draft)
--------------------------------------------------------------------------------

### [SrcTrait](./crates/draft/srctrait)
[![SrcTrait Crate Badge]][Backup Crate] [![Docs Badge]][SrcTrait Docs]
...
License (AGPL3)
--------------------------------------------------------------------------------
SourceTrait CLI: Command-line interface for SourceTrait projects  
